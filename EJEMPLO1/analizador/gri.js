...
break;
case 4:
 this.$ = new Nodo_Arbol("EXPRESION","");
                                                    this.$.agregarHijo(new Nodo_Arbol("expresion","expresion"));
                                                    this.$.agregarHijo($$[$0-2]);

    
break;
case 5:
this.$=new Nodo_Arbol("error","error");
...
case 12:  return 5;   
break;
case 13: document.getElementById("txtsalida1"+publico_id).value+='Error Lexico: ' + yy_.yytext + ', en la linea: ' + yy_.yylloc.first_line + ', en la columna: ' + yy_.yylloc.first_column +"\n"; 
break;
}
},
